...
public class UserConstants {
    ...
    public static final String USER_SELECTED_SHELTER_1 = "CAT";
    public static final String USER_SELECTED_SHELTER_2 = "CAT";
    public static final String USER_SELECTED_SHELTER_3 = "DOG";
    public static final String USER_STATE_1 = UserState.NEW_USER.name();
    public static final String USER_STATE_2 = UserState.NEW_USER.name();
    public static final String USER_STATE_3 = UserState.NEW_USER.name();
