...
public class PetReportConstants {
    ...
    public static final String PET_REPORT_SHELTER_TYPE_1 = ShelterType.CAT_SHELTER.name();
    public static final String PET_REPORT_SHELTER_TYPE_2 = ShelterType.CAT_SHELTER.name();
    public static final String PET_REPORT_SHELTER_TYPE_3 = ShelterType.DOG_SHELTER.name();
    ...
    public static final LocalDateTime PET_REPORT_TIME_SENDING_REPORT_1 = LocalDateTime.MIN.plusDays(1);
    public static final LocalDateTime PET_REPORT_TIME_SENDING_REPORT_2 = LocalDateTime.MIN.plusDays(2);
    public static final LocalDateTime PET_REPORT_TIME_SENDING_REPORT_3 = LocalDateTime.MIN.plusDays(3);
    public static final String PET_REPORT_PHOTO_PATH_1 = "PET_REPORT_PHOTO_PATH_1";
    public static final String PET_REPORT_PHOTO_PATH_2 = null;
    public static final String PET_REPORT_PHOTO_PATH_3 = "PET_REPORT_PHOTO_PATH_3";
    public static final String PET_REPORT_DIET_1 = "PET_REPORT_DIET_1";
    public static final String PET_REPORT_DIET_2 = "PET_REPORT_DIET_2";
    public static final String PET_REPORT_DIET_3 = "PET_REPORT_DIET_3";
    public static final String PET_REPORT_WELL_BEING_1 = "PET_REPORT_WELL_BEING_1";
    public static final String PET_REPORT_WELL_BEING_2 = "PET_REPORT_WELL_BEING_2";
    public static final String PET_REPORT_WELL_BEING_3 = "PET_REPORT_WELL_BEING_3";
    public static final String PET_REPORT_CHANGE_IN_BEHAVIOR_1 = "PET_REPORT_CHANGE_IN_BEHAVIOR_1";
    public static final String PET_REPORT_CHANGE_IN_BEHAVIOR_2 = "PET_REPORT_CHANGE_IN_BEHAVIOR_2";
    public static final String PET_REPORT_CHANGE_IN_BEHAVIOR_3 = "PET_REPORT_CHANGE_IN_BEHAVIOR_3";
    public static final String PET_REPORT_STATE_1 = PetReportState.FILLING.name();
    public static final String PET_REPORT_STATE_2 = PetReportState.WAITING_FOR_VERIFICATION.name();
    public static final String PET_REPORT_STATE_3 = PetReportState.ACCEPTED.name();
    ...
    public static final PetReportDtoOut PET_REPORT_DTO_OUT_1 = new PetReportDtoOut(PET_REPORT_ID_1, PET_REPORT_PHOTO_PATH_1,
            USER_DTO_OUT_1, PET_DTO_OUT_1, VOLUNTEER_DTO_OUT_1, PET_REPORT_TIME_SENDING_REPORT_1, PET_REPORT_DIET_1,
            PET_REPORT_WELL_BEING_1, PET_REPORT_CHANGE_IN_BEHAVIOR_1);
    public static final PetReportDtoOut PET_REPORT_DTO_OUT_2 = new PetReportDtoOut(PET_REPORT_ID_2, PET_REPORT_PHOTO_PATH_2,
            USER_DTO_OUT_2, PET_DTO_OUT_2, VOLUNTEER_DTO_OUT_2, PET_REPORT_TIME_SENDING_REPORT_2, PET_REPORT_DIET_2,
            PET_REPORT_WELL_BEING_2, PET_REPORT_CHANGE_IN_BEHAVIOR_2);
    public static final PetReportDtoOut PET_REPORT_DTO_OUT_3 = new PetReportDtoOut(PET_REPORT_ID_3, PET_REPORT_PHOTO_PATH_3,
            USER_DTO_OUT_3, PET_DTO_OUT_3, VOLUNTEER_DTO_OUT_3, PET_REPORT_TIME_SENDING_REPORT_3, PET_REPORT_DIET_3,
